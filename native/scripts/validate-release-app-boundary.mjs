...
export const forbiddenReleaseBasenames = Object.freeze([
  ...
  'chapter-01-review-text-freeze-v1.json',
  'review-ready-gate.json',
  'review-authorization.json',
  'probe-selection.json',
  'receipt-templates.json',
...
export const forbiddenReleaseByteSequences = Object.freeze([
  ...
  'NON_SHIPPING',
  'NON-SHIPPING',
  'CHAPTER_01_REVIEW_READY',
  'chapter-01-review-narration-v1',
  'chapter-01-review-transitions-v1',
  'review-world-',
