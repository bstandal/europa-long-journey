...
export const scenes: StoryScene[] = [
    ...
    interaction: {
      ...
      steps: [
        ...
        },
        {
          id: "danube-corridor",
          label: "The Danube",
          summary: "Rivers became corridors for people, livestock, seed and knowledge.",
          points: [
            { latitude: 39.5, longitude: 22.5, label: "Thessaly" },
        ...
        },
        {
          id: "central-villages",
          label: "New villages",
          summary: "Permanent settlements spread across the loess plains of central Europe.",
          points: [
            { latitude: 44.7, longitude: 22.4, label: "Iron Gates" },
            { latitude: 47.5, longitude: 19, label: "Middle Danube" },
      ...
      steps: [
        {
          id: "steppe-homeland",
          label: "The steppe",
          summary: "River, grassland and forest formed a mobile frontier north of the Black Sea.",
          points: [
        ...
        },
        {
          id: "westward",
          label: "Westward",
          summary: "People, herds and wagons moved through the plains north of the lower Danube.",
          points: [
            { latitude: 47.5, longitude: 34.5, label: "Lower Dnipro" },
        ...
        },
        {
          ...
          label: "Corded Ware",
          summary: "Steppe-related ancestry and new social networks spread deep into central and northern Europe.",
          points: [
            { latitude: 47.5, longitude: 19, label: "Carpathian Basin" },
      ...
      steps: [
        {
          id: "metals-north",
          label: "Metals north",
          summary: "Every piece of Nordic bronze depended on copper and tin arriving from beyond Scandinavia.",
          points: [
        ...
        },
        {
          id: "amber-south",
          label: "Amber south",
          summary: "Northern amber became a precious material far beyond the Baltic and North Sea.",
          points: [
            { latitude: 57, longitude: 9.2, label: "Limfjord" },
        ...
        },
        {
          ...
          summary: "Maritime skill tied coastal communities together and gave Nordic elites access to distant worlds.",
          points: [
            { latitude: 57, longitude: 9.2, label: "Limfjord" },
            { latitude: 58.7, longitude: 11.3, label: "Tanum" },
      ...
      steps: [
        {
          id: "poleis",
          label: "The poleis",
          summary: "Hundreds of small political communities offered rival forms of citizenship and rule.",
          points: [
        ...
        },
        {
          ...
          summary: "Persian expansion made the political autonomy of the city-states a question of survival.",
          points: [
      ...
      steps: [
        {
          ...
          summary: "Rome first built a system of alliances, colonies and roads across Italy.",
          points: [
        ...
        },
        {
          ...
          summary: "Conquest joined distant provinces to one military, fiscal and urban system.",
          points: [
            { latitude: 41.9, longitude: 12.5, label: "Rome" },
            { latitude: 37.98, longitude: 23.72, label: "Athens" },
        ...
        },
        {
          ...
          summary: "The Roman name became a legal identity shared across nearly the entire free population.",
          points: [
            { latitude: 41.9, longitude: 12.5, label: "Rome" },
  ...
  },
  {
    ...
    interaction: {
      family: "boundary",
      prompt: "Shift the imperial centre",
      accessibleSummary:
        "Snapshots for 312, 476 and 1453 show the Roman political centre moving east and surviving at Constantinople.",
      mapScope: "europe",
      steps: [
        {
          id: "constantine",
          label: "AD 312",
          summary: "Constantine joined imperial rule to Christianity and founded a new eastern capital.",
          points: [
            { latitude: 41.9, longitude: 12.5, label: "Rome" },
        ...
        },
        {
          id: "western-fall",
          label: "AD 476",
          summary: "The western court vanished while the eastern Roman state remained intact.",
          points: [
            { latitude: 44.42, longitude: 12.2, label: "Ravenna" },
            { latitude: 45, longitude: 4, label: "Former western provinces" },
            { latitude: 41.01, longitude: 28.97, label: "Constantinople" },
          ],
        },
        {
          id: "last-city",
          label: "AD 1453",
          summary: "After a millennium of survival, the eastern Roman capital fell to the Ottomans.",
          points: [
            { latitude: 41.01, longitude: 28.97, label: "Constantinople" },
            { latitude: 40, longitude: 25, label: "Aegean world" },
            { latitude: 42, longitude: 21, label: "Balkan inheritance" },
          ],
          closed: true,
        },
      ],
    ...
    hotspots: [
      ...
      },
      {
        ...
        label: "Ravenna",
        detail:
          "Late Roman and Ostrogothic rulers governed the western imperial inheritance from this Adriatic city.",
        latitude: 44.42,
        longitude: 12.2,
      },
    ],
      ...
      steps: [
        {
          ...
          summary: "Aachen joined royal power, Christian worship and a revived western imperial claim.",
          points: [
        ...
        },
        {
          ...
          summary: "New Christian monarchies carried the continental system eastward.",
          points: [
            { latitude: 50.78, longitude: 6.08, label: "Aachen" },
        ...
        },
        {
          ...
          summary: "Kyiv entered the Byzantine orbit while remaining part of Europe’s dynastic world.",
          points: [
            { latitude: 41.01, longitude: 28.97, label: "Constantinople" },
      ...
      steps: [
        {
          ...
          summary: "Kings treated bishops as pillars of royal government and invested them with office.",
          points: [
        ...
        },
        {
          id: "canossa",
          label: "Canossa, 1077",
          summary: "The emperor’s penance dramatised the pope’s claim to judge a Christian ruler.",
          points: [
        ...
        },
        {
          id: "worms",
          label: "Worms, 1122",
          summary: "The compromise distinguished spiritual office from temporal authority while leaving both institutions intact.",
          points: [
      ...
      steps: [
        {
          ...
          label: "Monasteries",
          summary: "Religious houses connected disciplined communities across local lordships.",
          points: [
        ...
        },
        {
          ...
          summary: "Urban communities created offices, privileges and rules that survived their members.",
          points: [
        ...
        },
        {
          id: "universities",
          label: "Universities",
          summary: "Students and masters formed self-governing corporations dedicated to learning.",
          points: [
            { latitude: 44.49, longitude: 11.34, label: "Bologna" },
      ...
      steps: [
        {
          id: "champagne-fairs",
          label: "The fairs",
          summary: "Seasonal fairs made Champagne a meeting place between northern producers and Italian merchants.",
          points: [
        ...
        },
        {
          id: "maritime-ports",
          label: "The ports",
          summary: "Competing maritime cities organised shipping, law and armed protection.",
          points: [
        ...
        },
        {
          id: "credit-network",
          label: "Credit",
          summary: "Documents allowed value and obligation to travel more safely than coin.",
          points: [
            { latitude: 44.41, longitude: 8.93, label: "Genoa" },
            { latitude: 48.3, longitude: 4.1, label: "Champagne" },
      ...
      steps: [
        {
          id: "western-route",
          label: "West",
          summary: "Cloth, salt and credit connected London and Bruges to the Baltic ports.",
          points: [
            { latitude: 51.51, longitude: -0.13, label: "London" },
            { latitude: 51.21, longitude: 3.22, label: "Bruges" },
        ...
        },
        {
          id: "northern-route",
          label: "North",
          summary: "Stockfish from Bergen entered an international urban trading system.",
          points: [
        ...
        },
        {
          id: "eastern-route",
          label: "East",
          summary: "Grain, timber, wax and furs moved through Baltic and Rus’ trading cities.",
          points: [
            { latitude: 53.87, longitude: 10.69, label: "Lübeck" },
      ...
      steps: [
        {
          id: "imperial-core",
          label: "The realm",
          summary: "The imperial claim joined German, Italian, Burgundian and Bohemian lands without making them uniform.",
          points: [
        ...
        },
        {
          id: "many-estates",
          label: "Many estates",
          summary: "Princes, bishops, cities and knights governed through different kinds of right.",
          points: [
        ...
        },
        {
          id: "law-and-peace",
          label: "Law and peace",
          summary: "Assemblies and courts gave rivals procedures short of private war.",
          points: [
      ...
      steps: [
        {
          id: "iberia",
          label: "Granada, 1492",
          summary: "The capture of Granada ended the last Muslim sovereign state in Iberia.",
          points: [
        ...
        },
        {
          ...
          label: "1453",
          summary: "Ottoman conquest replaced the eastern Roman state and opened a new Balkan frontier.",
          points: [
            { latitude: 41.01, longitude: 28.97, label: "Constantinople" },
            { latitude: 42.7, longitude: 23.32, label: "Sofia" },
        ...
        },
        {
          id: "vienna-siege",
          label: "Vienna, 1683",
          summary: "The failed siege marked the limit of Ottoman expansion into central Europe.",
          points: [
        ...
        },
        {
          ...
          summary: "A diplomatic settlement moved the frontier south-east and confirmed a new balance.",
          points: [
      ...
      steps: [
        {
          ...
          summary: "Portuguese voyages turned Atlantic islands and the African coast into a connected route.",
          points: [
        ...
        },
        {
          id: "india-route",
          label: "Around Africa",
          summary: "The Cape route gave Portugal direct armed access to the Indian Ocean.",
          points: [
            { latitude: 38.72, longitude: -9.14, label: "Lisbon" },
        ...
        },
        {
          ...
          summary: "Spain channelled American conquest and exchange through Seville.",
          points: [
      ...
      steps: [
        {
          id: "wittenberg-1517",
          label: "1517",
          summary: "A university dispute in Wittenberg entered the European print system.",
          points: [
        ...
        },
        {
          id: "confessions-1555",
          label: "1555",
          summary: "Lutheran, Reformed and Catholic territories formed a confessional patchwork.",
          points: [
            ...
            { latitude: 48.2, longitude: 16.37, label: "Catholic Habsburg lands" },
          ],
        },
        {
          id: "westphalia-1648",
          label: "1648",
          summary: "Peace accepted that Europe’s political order would persist without restored religious unity.",
          points: [
      ...
      steps: [
        {
          id: "crowns-1526",
          label: "1526",
          summary: "Austria, Bohemia and Hungary came under one dynasty after Mohács.",
          points: [
        ...
        },
        {
          id: "monarchy-1713",
          label: "1713",
          summary: "War and inheritance created a composite central European great power.",
          points: [
        ...
        },
        {
          id: "dual-monarchy",
          label: "1867",
          summary: "Austria-Hungary divided central institutions while preserving one dynasty and common foreign policy.",
          points: [
            { latitude: 48.21, longitude: 16.37, label: "Vienna" },
        ...
        },
        {
          id: "dissolution-1918",
          label: "1918",
          summary: "War destroyed the dynastic framework and released rival national projects.",
          points: [
      ...
      steps: [
        {
          id: "new-cosmos",
          label: "The cosmos",
          summary: "Astronomers joined inherited observations to new mathematics and instruments.",
          points: [
        ...
        },
        {
          id: "observation",
          label: "Observation",
          summary: "Universities, workshops and courts gave instruments and direct observation new authority.",
          points: [
        ...
        },
        {
          ...
          summary: "Societies, journals and letters made criticism part of organised knowledge.",
          points: [
            { latitude: 51.51, longitude: -0.13, label: "London" },
            { latitude: 48.86, longitude: 2.35, label: "Paris" },
      ...
      steps: [
        {
          id: "urban-republic",
          label: "The provinces",
          summary: "Power was distributed among provinces, cities and representative institutions.",
          points: [
            { latitude: 52.37, longitude: 4.9, label: "Amsterdam" },
        ...
        },
        {
          ...
          summary: "Markets for shares, debt and marine risk helped organise more voyages than any merchant house could finance alone.",
          points: [
            { latitude: 52.37, longitude: 4.9, label: "Amsterdam" },
            { latitude: 51.51, longitude: -0.13, label: "London" },
            { latitude: 53.55, longitude: 9.99, label: "Hamburg" },
        ...
        },
        {
          ...
          summary: "Printers, universities and migrant communities made the republic a European information centre.",
          points: [
            { latitude: 52.16, longitude: 4.49, label: "Leiden" },
            { latitude: 52.37, longitude: 4.9, label: "Amsterdam" },
      ...
      steps: [
        {
          ...
          summary: "Commercial cities supplied regular places and publications for political discussion.",
          points: [
            { latitude: 51.51, longitude: -0.13, label: "London" },
            { latitude: 52.37, longitude: 4.9, label: "Amsterdam" },
        ...
        },
        {
          ...
          summary: "Conversation, reputation and learned institutions carried criticism into elite society.",
          points: [
            { latitude: 48.86, longitude: 2.35, label: "Paris" },
            { latitude: 52.52, longitude: 13.41, label: "Berlin" },
            { latitude: 48.21, longitude: 16.37, label: "Vienna" },
        ...
        },
        {
          ...
          summary: "Books and periodicals let arguments cross political and confessional borders.",
          points: [
            { latitude: 55.95, longitude: -3.19, label: "Edinburgh" },
            { latitude: 51.51, longitude: -0.13, label: "London" },
            { latitude: 48.86, longitude: 2.35, label: "Paris" },
      ...
      steps: [
        {
          id: "craft-economy",
          label: "1700",
          summary: "Production remained distributed among farms, workshops, water power and urban crafts.",
          points: [
            { latitude: 51.51, longitude: -0.13, label: "London" },
        ...
        },
        {
          ...
          label: "1800",
          summary: "Coal and steam concentrated power in mines, mills and industrial towns.",
          points: [
        ...
        },
        {
          id: "railway-age",
          label: "1850",
          summary: "Railways cut journey and freight times, turning industrial growth into a continental race.",
          points: [
            { latitude: 51.51, longitude: -0.13, label: "London" },
            { latitude: 53.48, longitude: -2.24, label: "Manchester" },
            { latitude: 50.85, longitude: 4.35, label: "Brussels" },
      ...
      steps: [
        {
          id: "steam-routes",
          label: "Steam",
          summary: "Regular steam routes compressed oceanic time and linked ports to imperial systems.",
          points: [
            { latitude: 51.51, longitude: -0.13, label: "London" },
        ...
        },
        {
          id: "telegraph-cables",
          label: "Cables",
          summary: "Submarine cables brought distant command and information into near-real time.",
          points: [
            { latitude: 51.51, longitude: -0.13, label: "London" },
        ...
        },
        {
          ...
          summary: "European finance and military administration concentrated decisions far from their consequences.",
          points: [
            { latitude: 51.51, longitude: -0.13, label: "London" },
            { latitude: 48.86, longitude: 2.35, label: "Paris" },
            { latitude: 52.52, longitude: 13.41, label: "Berlin" },
      ...
      steps: [
        {
          id: "empires-1914",
          label: "1914",
          summary: "A small number of multinational empires organised most of central and eastern Europe.",
          points: [
        ...
        },
        {
          id: "new-states-1919",
          label: "1919",
          summary: "New and enlarged nation-states inherited disputed borders, minorities and unresolved grievances.",
          points: [
            { latitude: 52.23, longitude: 21.01, label: "Poland" },
            { latitude: 50.08, longitude: 14.44, label: "Czechoslovakia" },
        ...
        },
        {
          id: "ruin-1945",
          label: "1945",
          summary: "War, genocide and occupation left Europe ruined and divided between external superpowers.",
          points: [
            { latitude: 52.52, longitude: 13.41, label: "Berlin" },
      ...
      steps: [
        {
          id: "division-1945",
          label: "1945",
          summary: "Occupation and superpower rivalry divided Europe before reconstruction had begun.",
          points: [
        ...
        },
        {
          id: "community-1957",
          label: "1957",
          summary: "Six states placed strategic industries and markets inside common institutions.",
          points: [
        ...
        },
        {
          id: "western-order",
          label: "1973–86",
          summary: "Democratic enlargement extended the common legal and economic order.",
          points: [
        ...
        },
        {
          id: "berlin-1989",
          label: "1989",
          summary: "The opening of the Berlin Wall turned eastern dissent into continental transformation.",
          points: [
            { latitude: 52.52, longitude: 13.41, label: "Berlin" },
            { latitude: 52.23, longitude: 21.01, label: "Warsaw" },
            { latitude: 50.08, longitude: 14.44, label: "Prague" },
      ...
      steps: [
        {
          id: "opening-1991",
          label: "1991",
          summary: "Soviet rule ended and the continent’s sealed routes reopened.",
          points: [
            { latitude: 59.44, longitude: 24.75, label: "Tallinn" },
            { latitude: 52.23, longitude: 21.01, label: "Warsaw" },
            { latitude: 50.08, longitude: 14.44, label: "Prague" },
        ...
        },
        {
          ...
          summary: "Membership extended a common legal and economic order eastward in successive waves.",
          points: [
            { latitude: 50.85, longitude: 4.35, label: "Brussels" },
            { latitude: 52.23, longitude: 21.01, label: "Poland" },
        ...
        },
        {
          id: "nato-enlargement",
          label: "NATO",
          summary: "A separate security alliance extended collective defence into central and eastern Europe.",
          points: [
        ...
        },
        {
          ...
          summary: "Ukraine’s defence tests whether Europe’s institutions can also sustain strategic power.",
          points: [
            { latitude: 50.45, longitude: 30.52, label: "Kyiv" },
            { latitude: 49.84, longitude: 24.03, label: "Lviv" },
            { latitude: 52.23, longitude: 21.01, label: "Warsaw" },
...
export const storyEras = [
  ...
  { id: "early-modern", label: "Ocean, faith and knowledge", range: "1415–1789" },
